            ...
            <div className="content-container">
                <div className="content-container">
                    ...
                    <div className="field-container ip-field">
                        <TextField type="text" placeHolder={AddIPModal.PLACEHOLDER} title="Enter your IP" isRequired={true} handleChangeValue={setTarget} errorMessage="Target is required" isDisplayErrorMessage={isDisplayErrorMessageTargetField} />
                    </div>
                </div>
            </div>
